                    ...
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            <div class="btn-group mr-2 no-shadow">
                                <a href="<?= base_url($this->session->userdata('role') . '/projects') ?>" class="btn"><i class="fas fa-th-large"></i> <?= !empty($this->lang->line('label_grid_view')) ? $this->lang->line('label_grid_view') : 'Grid View'; ?></a>
                                ...
                                <a href="<?= base_url($this->session->userdata('role').'/projects/calendar') ?>" class="btn"><i class="fas fa-calendar-alt"></i> <?= !empty($this->lang->line('label_calendar_view')) ? $this->lang->line('label_calendar_view') : 'Calendar View'; ?></a>
                            </div>
                            ...
                            <div class='col-md-12'>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class='table-striped' id='projects_list' data-toggle="table" data-url="<?= base_url('admin/projects/get_projects_list') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-export-options='{
