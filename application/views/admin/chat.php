...
<head>
    ...
    <title>Chat Box &mdash; <?= get_admin_company_title($this->data['admin_id']); ?></title>
...
<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    if (empty($data_chat->messagingSenderId) || empty($data_chat->projectId) || empty($data_chat->apiKey)) { ?>
                        <div class="row alert alert-danger justify-content-center"> To use chat system you have to setup web FCM settings first. <a class="d-none" href="<?= base_url('admin/settings'); ?>"> Go to Settings</a> </div>
                    <?php } ?>
            ...
            <form action="<?= base_url('admin/chat/create_group'); ?>" class="modal-part" id="modal-add-group-part">
                <div class="row">
                    <div class="col-md-12">
            ...
            <form action="<?= base_url('admin/chat/edit_group'); ?>" class="modal-part" id="modal-edit-group-part">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label><?= !empty($this->lang->line('label_title')) ? $this->lang->line('label_title') : 'Title'; ?></label>
            ...
            <form action="<?= base_url('admin/chat/edit_group'); ?>" class="modal-part" id="modal-info-group-part">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label><?= !empty($this->lang->line('label_title')) ? $this->lang->line('label_title') : 'Title'; ?></label>
    ...
    <script src="<?= base_url('assets/backend/modules/ion.sound.min.js'); ?>"></script>

    <script src="<?= base_url('assets/backend/modules/firebase/firebase-app.js'); ?>"></script>

    <script src="<?= base_url('assets/backend/modules/firebase/firebase-messaging.js'); ?>"></script>

    <script src="<?= base_url('assets/backend/js/page/components-chat-box.js'); ?>"></script>
