...
<head>
    ...
    <title>Tasks &mdash; <?= get_admin_company_title($this->data['admin_id']); ?></title>
...
<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1> <a href="<?= base_url($this->session->userdata('role') . '/projects/details/' . $current_project['id']); ?>"><?= $current_project['title'] ?></a><?= !empty($this->lang->line('label_tasks')) ? $this->lang->line('label_tasks') : 'Tasks'; ?></h1>
                        <?php if (!is_client()) { ?>
                                                        ...
                                                        <div class="card-body p-3">
                                                                ...
                                                                <div class="card-header-action float-right">
                                                                    <div class="dropdown card-widgets">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            ...
                                                                            <a class="dropdown-item has-icon delete-task-alert" data-task_id="<?= $task['id'] ?>" data-project_id="<?= $current_project['id'] ?>" href="#"><i class="far fa-trash-alt"></i> <?= !empty($this->lang->line('label_delete')) ? $this->lang->line('label_delete') : 'Delete'; ?></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            <?php } ?>
                                                            ...
                                                            ?>
                                                                        <figure class="avatar mr-2 avatar-sm" data-toggle="tooltip" data-title="<?= $task_user['first_name'] ?>">
                                                                            <img alt="image" src="<?= base_url('assets/backend/profiles/' . $task_user['profile']); ?>" class="rounded-circle">
                                                                        </figure>
                                                                    <?php } else { ?>
                                                            ...
                                                            <?php if (!is_client()) { ?>
                                                                <div class="card-header-action float-right">
                                                                    <div class="dropdown card-widgets">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <a class="dropdown-item has-icon modal-edit-task-ajax" data-id="<?= $task['id'] ?>" href="#"><i class="fas fa-pencil-alt"></i> <?= !empty($this->lang->line('label_edit')) ? $this->lang->line('label_edit') : 'Edit'; ?></a>
                                                                            <a class="dropdown-item has-icon delete-task-alert" data-task_id="<?= $task['id'] ?>" data-project_id="<?= $current_project['id'] ?>" href="<?= base_url('admin/projects/delete_task/' . $task['id'] . '/' . $current_project['id']); ?>"><i class="far fa-trash-alt"></i> <?= !empty($this->lang->line('label_delete')) ? $this->lang->line('label_delete') : 'Delete'; ?></a></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            <?php } ?>
                                                            ...
                                                            <?php if (!is_client()) { ?>
                                                                <div class="card-header-action float-right">
                                                                    <div class="dropdown card-widgets">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <a class="dropdown-item has-icon modal-edit-task-ajax" data-id="<?= $task['id'] ?>" href="#"><i class="fas fa-pencil-alt"></i> <?= !empty($this->lang->line('label_edit')) ? $this->lang->line('label_edit') : 'Edit'; ?></a>
                                                                            <a class="dropdown-item has-icon delete-task-alert" data-task_id="<?= $task['id'] ?>" data-project_id="<?= $current_project['id'] ?>" href="<?= base_url('admin/projects/delete_task/' . $task['id'] . '/' . $current_project['id']); ?>"><i class="far fa-trash-alt"></i> <?= !empty($this->lang->line('label_delete')) ? $this->lang->line('label_delete') : 'Delete'; ?></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            <?php } ?>
            ...
            <form action="<?= base_url('admin/projects/create_task/' . $current_project['id']); ?>" method="post" class="modal-part" id="modal-add-task-part">
                <div class="row">
                    <div class="col-md-6">
            ...
            <form action="<?= base_url('admin/projects/edit_task'); ?>" method="post" class="modal-part" id="modal-edit-task-part">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?= !empty($this->lang->line('label_title')) ? $this->lang->line('label_title') : 'Title'; ?></label>
            ...
            <form action="<?= base_url('admin/projects/add_task_details'); ?>" enctype="multipart/form-data" class="modal-part" id="modal-add-task-details-part">
...
for ($i = 0; $i < count($user_names); $i++) {
    $comma = $i < count($user_names) - 1 ? ',' : '';
    $name = $user_names[$i]['first_name'] . ' ' . $user_names[$i]['last_name'];
...
<script src="<?= base_url('assets/backend/js/page/tasks.js'); ?>"></script>
