...
<head>
    ...
    <title>Notes &mdash; <?= get_admin_company_title($this->data['admin_id']); ?></title>
...
<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <?= form_open('admin/notes/create', 'id="modal-add-note-part"', 'class="modal-part"'); ?>
            ...
            <?= form_open('admin/notes/edit', 'id="modal-edit-note-part"', 'class="modal-part"'); ?>
            <div class="form-group">
                <label><?= !empty($this->lang->line('label_title')) ? $this->lang->line('label_title') : 'Title'; ?></label>
                <div class="input-group">
