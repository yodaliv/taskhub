...
<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
                    ...
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="btn-group mr-2 no-shadow">
                                <a href="<?= base_url($this->session->userdata('role') . '/projects') ?>" class="btn btn-primary text-white"><i class="fas fa-th-large"></i> <?= !empty($this->lang->line('label_grid_view')) ? $this->lang->line('label_grid_view') : 'Grid View'; ?></a>
                                <a href="<?= base_url($this->session->userdata('role') . '/projects/lists') ?>" class="btn"><i class="fas fa-list"></i> <?= !empty($this->lang->line('label_list_view')) ? $this->lang->line('label_list_view') : 'List View'; ?></a>
                        ...
                        <div class="row justify-content-center">
                            <div class="text-sm-right status-filter">
                                <div class="btn-group mb-3">
                                    <a href="<?= base_url($this->session->userdata('role') . '/projects'); ?>" class="btn btn-light <?= $this->input->get('filter') == '' ? 'custom-class' : '' ?>" data-status="All"><?= !empty($this->lang->line('label_all')) ? $this->lang->line('label_all') : 'All'; ?></a>
                                </div>
                                <div class="btn-group mb-3 ml-1">
                                    <a href="<?= base_url($this->session->userdata('role') . '/projects?filter=notstarted'); ?>" class="btn btn-light <?= $this->input->get('filter') == 'notstarted' ? 'custom-class' : '' ?>" data-status="notstarted"><?= !empty($this->lang->line('label_notstarted')) ? $this->lang->line('label_notstarted') : 'Not Started'; ?></a>
                                    <a href="<?= base_url($this->session->userdata('role') . '/projects?filter=ongoing'); ?>" class="btn btn-light <?= $this->input->get('filter') == 'ongoing' ? 'custom-class' : '' ?>" data-status="ongoing"><?= !empty($this->lang->line('label_ongoing')) ? $this->lang->line('label_ongoing') : 'Ongoing'; ?></a>
                                    <a href="<?= base_url($this->session->userdata('role') . '/projects?filter=finished'); ?>" class="btn btn-light <?= $this->input->get('filter') == 'finished' ? 'custom-class' : '' ?>" data-status="finished"><?= !empty($this->lang->line('label_finished')) ? $this->lang->line('label_finished') : 'Finished'; ?></a>
                                    <a href="<?= base_url($this->session->userdata('role') . '/projects?filter=onhold'); ?>" class="btn btn-light <?= $this->input->get('filter') == 'onhold' ? 'custom-class' : '' ?>" data-status="onhold"><?= !empty($this->lang->line('label_onhold')) ? $this->lang->line('label_onhold') : 'OnHold'; ?></a>
                                    <a href="<?= base_url($this->session->userdata('role') . '/projects?filter=cancelled'); ?>" class="btn btn-light <?= $this->input->get('filter') == 'cancelled' ? 'custom-class' : '' ?>" data-status="cancelled"><?= !empty($this->lang->line('label_cancelled')) ? $this->lang->line('label_cancelled') : 'Cancelled'; ?></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="card-header-action float-right">
                                                        <div class="dropdown card-widgets">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item has-icon delete-project-alert" href="<?= base_url($this->session->userdata('role') . '/projects/delete/' . $project['id']); ?>" data-project_id="<?= $project['id'] ?>"><i class="far fa-trash-alt"></i> <?= !empty($this->lang->line('label_delete')) ? $this->lang->line('label_delete') : 'Delete'; ?></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                                <div class="author-box-name">
                                                    <a href="<?= base_url($this->session->userdata('role') . '/projects/details/' . $project['id']); ?>"><?= $project['title'] ?></a>
                                                </div>
                                                ...
                                                <div class="mb-2 mt-3">
                                                    ...
                                                    <div class="float-right mt-sm-0 mt-3">
                                                        <a href="<?= base_url($this->session->userdata('role') . '/projects/details/' . $project['id']); ?>" class="btn btn-sm btn-primary no-shadow"><?= !empty($this->lang->line('label_details')) ? $this->lang->line('label_details') : 'Details'; ?> <i class="fas fa-chevron-right"></i></a>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <?php foreach ($project['projects_clients'] as $projects_clients) {
                                                                ...
                                                                if (isset($projects_clients['profile']) && !empty($projects_clients['profile'])) { ?>
                                                                    <a href="<?= base_url($this->session->userdata('role') . '/users/detail/' . $projects_clients['id']) ?>">
                                                                        <figure class="avatar avatar-md" data-toggle="tooltip" data-title="<?= $projects_clients['first_name'] ?>">
                                                                            <img alt="image" src="<?= base_url('assets/backend/profiles/' . $projects_clients['profile']); ?>" class="rounded-circle">
                                                                        </figure>
                                                                    </a>
                                                                <?php } else { ?>
                                                                    <a href="<?= base_url($this->session->userdata('role') . '/users/detail/' . $projects_clients['id']) ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <?php foreach ($project['projects_users'] as $projects_users) {
                                                            ...
                                                            if (isset($projects_users['profile']) && !empty($projects_users['profile'])) { ?>
                                                                <a href="<?= base_url($this->session->userdata('role') .'/users/detail/' . $projects_users['id']) ?>">
                                                                    <figure class="avatar avatar-md" data-toggle="tooltip" data-title="<?= $projects_users['first_name'] ?>">
                                                                        <img alt="image" src="<?= base_url('assets/backend/profiles/' . $projects_users['profile']); ?>" class="rounded-circle">
                                                                    </figure>
                                                                </a>
                                                            <?php } else { ?>
                                                                <a href="<?= base_url($this->session->userdata('role') .'/users/detail/' . $projects_users['id']) ?>">
            ...
            <form action="<?= base_url($this->session->userdata('role') . '/projects/create'); ?>" method="post" class="modal-part" id="modal-add-project-part">
                <div class="row">
                    <div class="col-md-6">
            ...
            <form action="<?= base_url($this->session->userdata('role') . '/projects/edit'); ?>" method="post" class="modal-part" id="modal-edit-project-part">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?= !empty($this->lang->line('label_title')) ? $this->lang->line('label_title') : 'Title'; ?></label>
    ...
    <script src="<?= base_url('assets/backend/js/page/components-user.js'); ?>"></script>
