...
<head>
    ...
    <title>Clients &mdash; <?= get_admin_company_title($this->data['admin_id']); ?></title>
...
<body>
    ...
    <script src="<?= base_url('assets/backend/js/page/components-clients.js'); ?>"></script>
