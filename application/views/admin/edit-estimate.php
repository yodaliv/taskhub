...
<head>
    ...
    <title>Edit Estimate &mdash; <?= get_admin_company_title($this->data['admin_id']); ?></title>
                            ...
                            <div class='col-md-12'>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?= base_url('admin/estimates/edit') ?>" id="edit_estimate_form">
...
<script src="<?= base_url('assets/backend/js/page/components-edit-estimate.js'); ?>"></script>
