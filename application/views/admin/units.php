...
<head>
    ...
    <title>Units &mdash; <?= get_admin_company_title($this->data['admin_id']); ?></title>
...
<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <?= form_open('admin/units/create', 'id="modal-add-unit-part"', 'class="modal-part"'); ?>
            <div class="row">
            ...
            <?= form_open('admin/units/edit', 'id="modal-edit-unit-part"', 'class="modal-part"'); ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label><?= !empty($this->lang->line('label_title')) ? $this->lang->line('label_title') : 'Title'; ?></label><span class="asterisk"> *</span>
    ...
    <script src="<?= base_url('assets/backend/js/page/components-units.js'); ?>"></script>
