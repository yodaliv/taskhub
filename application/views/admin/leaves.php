...
<head>
    ...
    <title>Leave Requests &mdash; <?= get_admin_company_title($this->data['admin_id']); ?></title>
...
<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
                            ...
                            <div class='col-md-12'>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class='table-striped' id='leaves_list' data-toggle="table" data-url="<?= base_url('admin/leaves/get_leaves_list') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="#toolbar" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-export-options='{
            ...
            <form action="<?= base_url('admin/leaves/create'); ?>" id="modal-add-leave-part" class="modal-part">
                <div class="row">
            ...
            <form action="<?= base_url('admin/leaves/edit'); ?>" id="modal-edit-leave-part" class="modal-part">
                <div class="row">
                    <div class="form-group col-md-6">
                        <label><?= !empty($this->lang->line('label_no_of_days')) ? $this->lang->line('label_no_of_days') : 'No. of Days'; ?></label>
                        <div class="input-group">
            ...
            <form action="<?= base_url('admin/leaves/leave_editors'); ?>" id="modal-leave-editors-part" class="modal-part">
                <div class="row">
    ...
    <script src="<?= base_url('assets/backend/js/page/leaves.js'); ?>"></script>
</body>
