...
<head>
    ...
    <title>Create Invoice &mdash; <?= get_admin_company_title($this->data['admin_id']); ?></title>
                    ...
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            <div class="btn-group mr-2 no-shadow">
                                <a class="btn btn-primary text-white" href="<?= base_url('admin/invoices') ?>" class="btn"><i class="fas fa-list"></i> <?= !empty($this->lang->line('label_invoices')) ? $this->lang->line('label_invoices') : 'Invoices'; ?></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class='col-md-12'>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?= base_url('admin/invoices/create') ?>" id="create_invoice_form">
