...
<head>
    ...
    <title>Project Details &mdash; <?= get_admin_company_title($this->data['admin_id']); ?></title>
...
<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            <a href="<?= base_url($this->session->userdata('role') . '/projects/tasks/' . $projects['id']); ?>" class="btn btn-primary btn-rounded no-shadow"><?= !empty($this->lang->line('label_project_tasks')) ? $this->lang->line('label_project_tasks') : 'Project Tasks'; ?></a>
                        </div>
                    </div>
                                                ...
                                                <?php if (empty($files)) { ?>
                                                    ...
                                                    foreach ($files as $file) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a download="<?= $file['original_file_name'] ?>" href="<?= base_url('assets/backend/project/' . $file['file_name']); ?>" class="btn btn-primary btn-action mt-1 "><i class="fas fa-download"></i></a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if (!hide_budget()) { ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a class="btn btn-danger btn-action mt-1 delete-milestone-alert" data-milestone_id="<?= $milestone['id'] ?>" data-project_id="<?= $projects['id'] ?>" href="#"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                        <?php } ?>
                                                    </tr>
                                                <?php } ?>
            ...
            <form action="<?= base_url('admin/projects/create_milestone/' . $projects['id']); ?>" method="post" class="modal-part" id="modal-add-milestone-part">
                <div class="row">
                    <div class="col-md-6">
            ...
            <form action="<?= base_url('admin/projects/edit_milestone'); ?>" method="post" class="modal-part" id="modal-edit-milestone-part">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?= !empty($this->lang->line('label_title')) ? $this->lang->line('label_title') : 'Title'; ?></label>
    ...
    <script src="<?= base_url('assets/backend/js/page/project-details.js'); ?>"></script>
