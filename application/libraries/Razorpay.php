...
class Razorpay
{
    ...
    function __construct()
    {
        ...
        $this->key_id = (isset($razorpay_payment_method['razorpay_key_id'])) ? $razorpay_payment_method['razorpay_key_id'] : "";
        $this->secret_key = (isset($razorpay_payment_method['razorpay_secret_key'])) ? $razorpay_payment_method['razorpay_secret_key'] : "";
