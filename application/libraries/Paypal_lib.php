...
class Paypal_lib
{
    ...
    function __construct()
    {
        ...
        $mode = $paypal_payment_method['paypal_mode'];
        ...
        $businessEmail = $paypal_payment_method['business_email'];
        $this->add_field('business', $businessEmail);
        $this->add_field('rm', '2');
        $this->add_field('cmd', '_xclick');

        $this->add_field('currency_code', $paypal_payment_method['currency_code']);
    ...
    function paypal_auto_form()
    {
        ...
        echo '<html>' . "\n";
        echo '<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>Processing Payment.. Please wait.. |' . get_compnay_title() . '</title>
    ...
    function paypal_form($form_name = 'paypal_form')
    {
        ...
        $str .= '<p><img src="' . base_url('assets/backend/img/old-pre-loader.gif') . '" alt="Please wait.. Loading" title="Please wait.. Loading.." width="140px" /></p>';
