...
if($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST) {
    ...
    if(!empty($_POST['hostname']) && !empty($_POST['username']) && !empty($_POST['database'])  && !empty($_POST['super_admin_email'])  && !empty($_POST['app_url'])){
        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="admin_email" class="form-control" name="super_admin_email" />
                    <p class="help-block">Your Super admin Email.</p>
                </div>
                
                <div class="form-group">
                    <label for="admin_password">Super admin Password</label>
                    <input type="text" id="admin_password" class="form-control" name="super_admin_password" />
                    <p class="help-block">Your Super admin Password.</p>
                </div>
